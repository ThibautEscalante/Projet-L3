...
<?php
	...
	$nuc = mysqli_query($bdd, "SELECT * FROM production WHERE typeProd='nucleaire' AND production.codeINSEE='".$_GET['region']."' AND production.dateProd BETWEEN '".$_GET['date1']."' AND '".$_GET['date2']."'");
	if($nuc)
	{
		$Labels = array();
	...
	$eol = mysqli_query($bdd, "SELECT * FROM production WHERE typeProd='nucleaire' AND production.codeINSEE='".$_GET['region']."' AND production.dateProd BETWEEN '".$_GET['date1']."' AND '".$_GET['date2']."'");
	if($eol)
	{
		$Labels = array();
	...
	$cha = mysqli_query($bdd, "SELECT * FROM production WHERE typeProd='nucleaire' AND production.codeINSEE=".$_GET['region']." AND production.dateProd BETWEEN '".$_GET['date1']."' AND '".$_GET['date2']."'");
	if($cha)
	{
		$Labels = array();
	...
	$gaz = mysqli_query($bdd, "SELECT * FROM production WHERE typeProd='nucleaire' AND production.codeINSEE=".$_GET['region']." AND production.dateProd BETWEEN '".$_GET['date1']."' AND '".$_GET['date2']."'");
	if($gaz)
	{
		$Labels = array();
	...
	$sol = mysqli_query($bdd, "SELECT * FROM production WHERE typeProd='nucleaire' AND production.codeINSEE=".$_GET['region']." AND production.dateProd BETWEEN '".$_GET['date1']."' AND '".$_GET['date2']."'");
	if($sol)
	{
		$Labels = array();
	...
	$hyd = mysqli_query($bdd, "SELECT * FROM production WHERE typeProd='nucleaire' AND production.codeINSEE=".$_GET['region']." AND production.dateProd BETWEEN '".$_GET['date1']."' AND '".$_GET['date2']."'");
	if($hyd)
	{
		$Labels = array();
	...
	$bio = mysqli_query($bdd, "SELECT * FROM production WHERE typeProd='nucleaire' AND production.codeINSEE=".$_GET['region']." AND production.dateProd BETWEEN '".$_GET['date1']."' AND '".$_GET['date2']."'");
	if($bio)
	{
		$Labels = array();
...
?>
	...
	<script>
		...
		Chart.defaults.global.title.text = "Evolution des émissions en CO2 en Occitanie";
