...
<?php
	...
	$nuc = mysqli_query($bdd, "SELECT * FROM production WHERE typeProd='nucleaire' AND production.codeINSEE=93 ORDER BY dateProd ASC");
	if($nuc)
	{
		$Labels = array();
	...
	$fio = mysqli_query($bdd, "SELECT * FROM production WHERE typeProd='fioul' AND production.codeINSEE=93 ORDER BY dateProd ASC");
	if($fio)
	{
		$Labels = array();
	...
	$eol = mysqli_query($bdd, "SELECT * FROM production WHERE typeProd='eolien' AND production.codeINSEE=93 ORDER BY dateProd ASC");
	if($eol)
	{
		$Labels = array();
	...
	$cha = mysqli_query($bdd, "SELECT * FROM production WHERE typeProd='charbon' AND production.codeINSEE=93 ORDER BY dateProd ASC");
	if($cha)
	{
		$Labels = array();
	...
	$gaz = mysqli_query($bdd, "SELECT * FROM production WHERE typeProd='gaz' AND production.codeINSEE=93 ORDER BY dateProd ASC");
	if($gaz)
	{
		$Labels = array();
	...
	$sol = mysqli_query($bdd, "SELECT * FROM production WHERE typeProd='solaire' AND production.codeINSEE=93 ORDER BY dateProd ASC");
	if($sol)
	{
		$Labels = array();
	...
	$hyd = mysqli_query($bdd, "SELECT * FROM production WHERE typeProd='hydraulique' AND production.codeINSEE=93 ORDER BY dateProd ASC");
	if($hyd)
	{
		$Labels = array();
	...
	$bio = mysqli_query($bdd, "SELECT * FROM production WHERE typeProd='bio-energies' AND production.codeINSEE=93 ORDER BY dateProd ASC");
	if($bio)
	{
		$Labels = array();
...
?>
	...
	<script>
		...
		Chart.defaults.global.title.text = "Evolution des émissions en CO2 en Provence-Alpes-Côte-d'Azur";
